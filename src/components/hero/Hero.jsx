import "./hero.css";
import { ArrowRight } from "lucide-react"; // Lucide-react for modern icons
const Hero = () => {
  return (
    <div className="hero">
      <div className="about">
        ...
        <div className="about-icons">
          <a href="https://www.linkedin.com/in/kyuceak/" target="_blank">
          ...
          <a href="https://github.com/kyuceak" target="_blank">
            <svg viewBox="0 0 128 128">
              <g fill="#181616">
                <path
                  fillRule="evenodd"
